    ...
    <div id="page-wrapper">        
        <header>
            ...
            <div class="front-link">
                ...
                <a href="{{ route("courier.dashboard") }}">Oikotan</a>
            </div>
            ...
            <ul class="top-menu">
                ...
                <li id="">
                    ...
                    <div class="option-dropdown header-profile-box">
                        <ul class="user-info">
                            <li><a href="{{ route("courier.profile") }}">My Profile</a></li>
                            <li><a href="">Edit Profile</a></li>
                            <li>
                                <a href="javascript:void" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                    {{ __('Logout') }}
                                </a>
                                <form id="logout-form" action="{{ route('courier.logout') }}" method="POST" class="d-none">
                                    @csrf
                                </form>
                            </li>
                        </ul>
