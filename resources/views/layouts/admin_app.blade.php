            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" id="sub-menu">
                        ...
                        <li><a href="{{ route('admin.user') }}">Add New User</a></li>
                        <li><a href="{{ route( "admin.user.edit", Auth::user()->id ) }}">Profile</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript:void" class="{{ Route::currentRouteName() == 'admin.roles' ? 'active' : '' }}"><i class="fas fa-user"></i> User Management</a>
                    <ul class="sub-menu" id="sub-menu">
